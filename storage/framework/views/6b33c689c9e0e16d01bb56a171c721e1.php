...
<head>
    ...
    <title> <?php echo e(isset($siteName) && $siteName ? $siteName : trans('global.site_title')); ?></title>
    ...
    <link type="text/css" href="<?php echo e(asset('css/custom.css')); ?>?<?php echo e(time()); ?>" rel="stylesheet" />
     <link type="text/css" href="<?php echo e(asset('css/dashboard.css')); ?>?<?php echo e(time()); ?>" rel="stylesheet" />
...
<body class="sidebar-mini skin-purple" style="height: auto; min-height: 100%;">
    <div class="wrapper" style="height: auto; min-height: 100%;">
        <header class="main-header cvvv">
            <a href="/admin/" class="logo">
                <span class="logo-mini">
                    <?php if(isset($logoPath) && !empty($logoPath) && file_exists(public_path($logoPath))): ?>
            ...
            <nav class="navbar navbar-static-top">
                ...
                <div class="navbar-custom-menu" style="display: none;">
                    <ul class="nav navbar-nav">
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('language_setting_access')): ?>
                            <?php if(count(config('global.available_languages', [])) > 1): ?>
                                <li class="dropdown notifications-menu">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <ul class="menu">
                                                <?php $__currentLoopData = config('global.available_languages'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $langLocale => $langName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <li>
        ...
        <footer class="main-footer text-center">
            <strong><?php echo e($siteName); ?> &copy;</strong> <?php echo e(trans('global.allRightsReserved')); ?> Powered by <a
...
</html><?php /**PATH /home/unibooker-rideon-code/htdocs/rideon-code.unibooker.app/resources/views/layouts/admin.blade.php ENDPATH**/ ?>