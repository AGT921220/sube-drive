...
class SupportTicketController extends Controller
{
    ...
    public function createSupportTicket(Request $request)
    {
        ...
        return $this->successResponse(200, trans('global.Support_ticket_thread_created_successfully'), ['thread' => $thread]);
        try {
        } catch (\Exception $e) {
    ...
    public function replyToSupportTicket(Request $request)
    {
        ...
        if (! $thread) {
            return $this->errorResponse(404, trans('global.Support_ticket_thread_not_found'));
        }

        if ($thread->user_id != $user->id) {
            return $this->errorResponse(403, trans('global.not_have_permission'));
        }
        $thread_status = 1;
        $thread->update([
        ...
        return $this->successResponse(200, trans('global.Support_ticket_reply_created_successfully'), ['reply' => $reply]);
        try {
        } catch (\Exception $e) {
            return $this->errorResponse(500, trans('global.something_wrong'), $e->getMessage());
        }
    ...
    public function getUserThreads(Request $request)
    {
        ...
        try {
            ...
            return $this->successResponse(200, trans('global.User_threads_retrieved_successfully'), ['threads' => $threads, 'offset' => $nextOffset]);
        } catch (\Exception $e) {
            return $this->errorResponse(500, trans('global.something_wrong'), $e->getMessage());
        }
    }
    ...
    public function getReplyThreads(Request $request)
    {
        try {
            ...
            if ($validator->fails()) {
                return $this->errorResponse(400, trans('global.Validation_error'), $validator->errors());
            }
            ...
            if (trim($thread->user_id) === trim($user->id)) {
                ...
                return $this->successResponse(200, trans('global.Reply_threads_retrieved_successfully'), [
                    'replyThreads' => $replyThreads,
                    'offset' => $nextOffset,
                ]);
            } else {
                return $this->errorResponse(403, trans('global.You_do_not_have_permission_view_this_thread'));
            }
        } catch (\Exception $e) {
            return $this->errorResponse(500, trans('global.something_wrong'), $e->getMessage());
        }
    ...
    public function closeSupportTicket(Request $request)
    {
        try {
            ...
            if ($thread->user_id != $user->id) {
                return $this->errorResponse(403, trans('global.You_do_not_have_permission_close_this_thread'));
            }

            $thread->thread_status = 0;
            $thread->save();

            return $this->successResponse(200, trans('global.support_ticket_closed_successfully'));
        } catch (\Exception $e) {
            return $this->errorResponse(500, trans('global.something_wrong'), $e->getMessage());
        }
    }
