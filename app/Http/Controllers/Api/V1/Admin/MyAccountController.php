...
class MyAccountController extends Controller
{
    ...
    public function insertBankAccount(Request $request)
    {
        try {
            ...
            $message = $bankAccount->wasRecentlyCreated ? trans('global.bank_account_created_successfully') : trans('global.bank_account_updated_successfully');
    ...
    public function getBankAccount(Request $request)
    {
        ...
        if (! $bankAccount) {
            return $this->addErrorResponse(200, trans('global.bank_account_not_found'), ['data' => $bankAccount]);
        }

        return $this->addSuccessResponse(200, trans('global.bank_account_retrieved_successfully'), ['data' => $bankAccount]);
    }
    ...
    public function toggleProductStatus(Request $request)
    {
        ...
        if (! $item) {
            return $this->addErrorResponse(404, trans('global.product_not_found'), '');
        }
        ...
        return $this->addSuccessResponse(200, trans('global.product_status_updated_successfully'), [
